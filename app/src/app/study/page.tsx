...
import { MilestoneMap } from '../../components/study/MilestoneMap';
import { milestones } from '../../data/milestones';

export default function StudyPage() {
  const { milestones: progress } = useProgressStore();
  ...
  return (
    <div className="flex-1 flex flex-col p-6">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-xs text-text-secondary leading-none">
            Completa i 10 passi per coprire il programma d&apos;esame.
          </p>
        </div>
      </div>
      ...
      <div className="flex-grow flex flex-col justify-start">
        <MilestoneMap milestones={milestones} progress={progress} />
      </div>
    </div>
  );
}
